...
The project is split into two mutually exclusive build modes controlled by a single CMake option (`BUILD_FIRMWARE`). A given build directory is always one or the other — never both.
